...
const user = {
    ...
    userCurrentSelections: atomWithStorage("userCurrentSelections", { dealership_id: null, vehicle_id: null, hotspot_type: null, hotspot_id: null, photo_id: null, refreshPage: false, cameraOn: false }),
